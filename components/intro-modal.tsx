          ...
          >
            ...
            <div className="flex items-center justify-between px-6 pt-6 pb-4">
              <div>
                ...
                <p className="text-xs text-muted-foreground/60 font-mono uppercase tracking-widest text-balance">
            ...
            <div className="flex items-center justify-between px-6 py-4 border-t border-white/[0.06]">
              <p className="text-xs text-muted-foreground/40">
                You can replay this anytime via the <span className="font-mono font-semibold text-muted-foreground/60">?</span> button
              </p>
              <button
                onClick={onClose}
                className="px-4 py-1.5 text-xs font-mono font-medium rounded-sm bg-white/8 hover:bg-white/15 text-foreground/70 hover:text-foreground border border-white/10 hover:border-white/20 transition-colors active:scale-[0.98]"
              >
                Skip to app →
              </button>
            </div>
