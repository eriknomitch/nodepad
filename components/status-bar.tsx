  ...
  return (
    <header className="flex h-10 items-center justify-between border-b border-border bg-card/80 backdrop-blur-md px-3 py-1.5 z-50">
        ...
        <div className="flex items-center gap-2.5 ml-1">
          ...
          {activeProjectName && (
            <div className="flex items-center gap-2 ml-1">
              ...
              <span className="font-mono text-[9px] text-muted-foreground font-semibold uppercase tracking-[0.2em]">{activeProjectName}</span>
            </div>
          )}
        </div>
      </div>
      ...
      <div className="flex items-center gap-4">
        {blockCount > 0 && (
          <div className="flex items-center gap-4">
            <span className="font-mono text-[9px] text-muted-foreground/40 font-semibold uppercase tracking-wider tabular-nums">
                ...
                <div className="flex items-center gap-3">
                  {typeCounts.map(([type, count]) => {
                    ...
                    return (
                      <span
                        key={type}
                        className="font-mono text-[9px] font-semibold uppercase tracking-tighter tabular-nums"
        ...
        <div className="flex items-center gap-2 border-l border-white/5 pl-4 ml-4">
          ...
          >
            ...
            {ghostNoteCount > 0 && !isGhostPanelOpen && (
              <span className="absolute -top-1 -right-1 flex h-3.5 w-3.5 items-center justify-center rounded-full bg-primary font-mono text-[7px] font-semibold text-primary-foreground tabular-nums">
                {ghostNoteCount}
              </span>
            )}
          </button>
